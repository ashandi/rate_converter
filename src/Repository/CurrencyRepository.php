...
class CurrencyRepository extends ServiceEntityRepository
{
    ...
    public function getOrCreate(string $name)
    {
        ...
        $tableName = $this->getEntityManager()->getClassMetadata(Currency::class)->getTableName();

        //$connection->executeQuery("LOCK TABLES $tableName READ");

        $currency = $this->findOneBy(['name' => $name]);
